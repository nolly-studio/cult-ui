...
::component-preview{name="pixel-heading-character-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="Interactive playground"}
::
...
::component-source{name="pixel-heading-character"}
::
