...
::component-preview{name="expandable-screen-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="All variations"}
::
...
label: "Inspiration"
items:
  - text: "Animations.dev - Morphing Animations"
    href: "https://animations.dev/"
  - text: "v0.app/@joelbqz - Expandable Screen Component"
...
::component-source{name="expandable-screen"}
::
