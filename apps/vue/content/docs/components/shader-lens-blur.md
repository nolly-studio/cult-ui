...
::component-preview{name="shader-lens-blur-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="Interactive playground"}
::
...
::component-source{name="shader-lens-blur"}
::
