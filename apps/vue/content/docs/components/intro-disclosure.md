...
::component-preview{name="intro-disclosure-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]"}
::
...
::component-source{name="intro-disclosure"}
::
...
::component-preview{name="intro-disclosure-demo"}
::
