...
::component-preview{name="texture-overlay-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="All texture patterns and variations"}
::
...
::component-source{name="texture-overlay"}
::
