...
::component-preview{name="hero-liquid-metal-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[95%]" description="Responsive hero section with desktop and mobile LiquidMetal shader treatments"}
::
...
::component-source{name="hero-liquid-metal"}
::

Optionally copy the demo as a starting point.

::component-source{name="hero-liquid-metal-demo"}
::
