...
::component-preview{name="hero-color-panels-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[95%]" description="Responsive hero section with desktop and mobile ColorPanels shader treatments"}
::
...
::component-source{name="hero-color-panel"}
::

Optionally copy the demo as a starting point.

::component-source{name="hero-color-panels-demo"}
::
