...
::component-preview{name="pixel-heading-word-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="Interactive playground"}
::
...
::component-source{name="pixel-heading-word"}
::
