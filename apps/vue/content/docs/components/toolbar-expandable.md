...
::component-preview{name="toolbar-expandable-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="All variations"}
::
...
label: "Inspiration"
items:
  - text: "Toolbar Expandable by Motion Primitives"
...
::component-source{name="toolbar-expandable"}
::
