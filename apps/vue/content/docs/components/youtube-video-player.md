...
::component-preview{name="youtube-video-player-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="Interactive YouTube video player with multiple examples"}
::
...
::component-source{name="youtube-video-player"}
::
