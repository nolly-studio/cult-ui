...
::component-preview{name="family-drawer-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="All variations"}
::
...
label: "Inspiration"
items:
  - text: "Animations.dev - Family Drawer Walkthrough"
...
::component-source{name="family-drawer"}
::
