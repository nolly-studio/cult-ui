...
::component-preview{name="pixel-paragraph-words-inverse-demo" className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]" description="Interactive playground"}
::
...
::component-source{name="pixel-paragraph-words-inverse"}
::
