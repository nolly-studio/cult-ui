...
const props = withDefaults(defineProps<Props>(), {
  ...
  mouseTrackingStiffness: 100,
  mouseTrackingDamping: 20,
  waveIntensity: 30,
  waveRadius: 200,
...
<template>
  <Transition name="fade" appear>
    ...
    >
      ...
      <div
        v-if="enableGradient"
        class="absolute inset-0 h-full w-full gradient-animate"
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
          ...
          <rect width="100%" height="100%" filter="url(#noise-canvas)" />
        </svg>
      </div>
