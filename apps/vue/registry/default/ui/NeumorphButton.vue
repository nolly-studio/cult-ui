...
const buttonVariants = cva(
  'justify-center px-4 text-sm font-medium items-center transition-[box-shadow,background-color] disabled:cursor-not-allowed disabled:opacity-50 flex active:transition-none',
  {
    variants: {
      intent: {
        default: [
          'bg-[#36322F]', 'text-[#fff]', 'hover:enabled:bg-[#4a4542]', 'disabled:bg-[#8c8885]',
          ...
          'disabled:shadow-none', 'active:bg-[#2A2724]',
          'active:[box-shadow:inset_0px_-1.5px_0px_0px_#171310,_0px_0.5px_2px_0px_rgba(58,_33,_8,_70%)]',
        ],
        primary: [
          'bg-[#2C7BE5]', 'text-[#fff]', 'hover:enabled:bg-[#3D8DF5]', 'disabled:bg-[#9FC3F5]',
          ...
          'disabled:shadow-none', 'active:bg-[#1A68D1]',
          'active:[box-shadow:inset_0px_-1.5px_0px_0px_#1554AB,_0px_0.5px_2px_0px_rgba(28,_100,_242,_70%)]',
        ],
        secondary: [
          'bg-[#FFFFFF]', 'text-[#36322F]', 'hover:enabled:bg-[#F8F8F8]', 'disabled:bg-[#F0F0F0]',
          ...
          'disabled:shadow-none', 'border', 'border-[#E0E0E0]', 'active:bg-[#F0F0F0]',
          'active:[box-shadow:inset_0px_-1.5px_0px_0px_#D8D8D8,_0px_0.5px_2px_0px_rgba(0,_0,_0,_15%)]',
        ],
        danger: [
          'bg-[#E6492D]', 'text-[#fff]', 'hover:enabled:bg-[#F05B41]', 'disabled:bg-[#F5A799]',
          ...
          'disabled:shadow-none', 'active:bg-[#D63A1F]',
...
const classes = computed(() =>
  buttonVariants({ intent: props.intent, size: props.size, fullWidth: props.fullWidth || undefined, className: props.class })
)
</script>
...
<template>
  <button
    ...
    class="hover:scale-[1.02] active:scale-[0.98] transition-transform"
  >
    <Loader2 v-if="props.loading" class="mr-2 h-4 w-4 animate-spin" />
    <span :style="{ opacity: props.loading ? 0.7 : 1, transition: 'opacity 0.2s' }">
      <slot />
    </span>
  </button>
</template>
