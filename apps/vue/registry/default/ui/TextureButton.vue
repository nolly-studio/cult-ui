...
const outerClass = computed(() =>
  cn(buttonVariantsOuter({ variant: props.variant, size: props.size }), props.class)
)

const innerClass = computed(() =>
  cn(innerDivVariants({ variant: props.variant, size: props.size }))
)
</script>

<template>
  <button :class="outerClass" type="button">
