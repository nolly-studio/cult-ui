        ...
        <div class="flex flex-col items-center pt-4">
          ...
          <div class="relative mx-auto my-[10px] w-[60px] md:w-[150px] overflow-hidden">
            <div class="md:p-6 p-2">
              ...
              <!-- Spotify icon -->
              <div v-else-if="activeTab === 1" class="flex items-center justify-center">
                <svg viewBox="0 0 256 256" width="5em" height="5em" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
