...
<ComponentPreview
  ...
  description="Responsive hero section with desktop and mobile StaticRadialGradient shader treatments"
/>
...
<ComponentSource name="hero-static-radial-gradient" />

<Step>Optionally copy the demo as a starting point.</Step>

<ComponentSource name="hero-static-radial-gradient-demo" />
