...
<ComponentPreview
  ...
  description="Responsive hero section with desktop and mobile dithering treatments"
/>
...
<ComponentSource name="hero-dithering" />

<Step>Optionally copy the demo as a starting point.</Step>

<ComponentSource name="hero-dithering-demo" />
