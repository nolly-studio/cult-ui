...
<ComponentPreview
  ...
  className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[88%]"
  description="Interactive command tabs with staged output animation"
/>
...
<ComponentSource name="terminal-animation-demo" />

<Step>Add this cursor blink utility to your global stylesheet (for example, <code>globals.css</code>).</Step>
