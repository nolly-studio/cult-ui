...
<ComponentPreview
  ...
  description="Responsive hero section with desktop and mobile Heatmap shader treatments"
/>
...
<ComponentSource name="hero-heatmap" />

<Step>Optionally copy the demo as a starting point.</Step>

<ComponentSource name="hero-heatmap-demo" />
