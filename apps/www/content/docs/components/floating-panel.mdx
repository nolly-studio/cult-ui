  ...
  return (
    <div className="p-8">
      <h1 className="mb-4 text-2xl font-bold">
        Headless Composable FloatingPanel Demo
      </h1>
      <FloatingPanelRoot>
...
```typescriptreact
<FloatingPanelRoot>{/* Other FloatingPanel components */}</FloatingPanelRoot>
```
...
```typescriptreact
<FloatingPanelContent>{/* FloatingPanel content */}</FloatingPanelContent>
```
...
```typescriptreact
<FloatingPanelFooter>{/* Footer content */}</FloatingPanelFooter>
```
