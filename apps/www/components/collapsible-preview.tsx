...
export function CollapsiblePreview({
  ...
  return (
    <CollapsiblePreviewContext.Provider value={value}>
      <div className="bg-muted shadow-elevation-light w-full rounded-xl p-2">
...
export function CollapsiblePreviewMore({
  ...
  const defaultPreviewRenderer = (
    ...
    <div className="flex flex-col items-center" key={item.id}>
      <div className="border-border relative mb-3 aspect-[4/3] w-full overflow-hidden rounded-lg border">
        <div className="bg-muted absolute top-0 right-0 left-0 z-10 flex h-6 items-center px-2">
        ...
        <div className="absolute inset-0 pt-6">
          <div className="relative h-full w-full">
            ...
            />
            <div className="via-background/20 to-background/40 absolute inset-0 bg-gradient-to-b from-transparent" />
          </div>
        </div>
      </div>
