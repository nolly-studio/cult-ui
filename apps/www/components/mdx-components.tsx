...
// // Citation components defined outside the components object
// const CitationList = ({ className, ...props }) => (
//   <ul className={cn("list-none pl-0", className)} {...props} />
// )

// const CitationItem = ({ className, ...props }) => (
//   <li
...
// const CitationLink = ({ className, ...props }) => (
//   <a className={cn(" ml-1 hover:underline", className)} {...props} />
// )

// const Citations = ({ className, ...props }) => (
//   <div
//     className={cn(
...
// // Add Citation components to the components object
...
//   // For fumadocs, we need to render the MDX content differently
//   // The code prop should contain the compiled MDX content
//   return (
//     <div className="mdx">
//       {/* This will be handled by fumadocs-mdx runtime */}
