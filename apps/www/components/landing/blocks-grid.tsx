...
export function MiniBlocksGrid() {
  return (
    <section className="mx-auto max-w-6xl py-16 md:px-4 md:py-12">
      {/* Section Header */}
      <div className="mb-12 text-center">
        ...
        <div className="mx-auto mb-8 flex max-w-2xl items-center justify-center gap-4">
          ...
          <div className="border-border bg-background flex items-center gap-2 border px-4 py-2">
            <Shapes className="size-3.5 fill-[#ADFA1B]/50 md:size-4" />
        ...
        <p className="text-foreground/70 mx-auto max-w-md text-base leading-relaxed font-light md:text-lg">
        ...
        {BLOCK_PREVIEW_DATA.slice(0, 6)
          ...
          .map((block) => (
            <a
              ...
              className="group border-border bg-background hover:border-foreground/10 hover:shadow-primary/5 relative flex flex-col border transition-all duration-150 hover:shadow-lg"
            >
              {/* Corner accents */}
              <div className="border-primary/50 pointer-events-none absolute -top-px -left-px h-3 w-3 border-t-2 border-l-2 opacity-0 transition-all duration-200 group-hover:opacity-100" />
              <div className="border-primary/50 pointer-events-none absolute -top-px -right-px h-3 w-3 border-t-2 border-r-2 opacity-0 transition-all duration-200 group-hover:opacity-100" />
              <div className="border-primary/50 pointer-events-none absolute -bottom-px -left-px h-3 w-3 border-b-2 border-l-2 opacity-0 transition-all duration-200 group-hover:opacity-100" />
              <div className="border-primary/50 pointer-events-none absolute -right-px -bottom-px h-3 w-3 border-r-2 border-b-2 opacity-0 transition-all duration-200 group-hover:opacity-100" />

              {/* Content */}
              <div className="flex flex-1 flex-col p-4">
                <h3 className="mb-2 line-clamp-1 text-sm leading-tight font-medium tracking-tight">
                  {block.title}
                </h3>

                {block.meta.problemSolved && (
                  <p className="text-muted-foreground mb-4 line-clamp-3 flex-1 text-xs leading-relaxed font-light">
                    {block.description}
                  </p>
                )}
                  ...
                  <div className="flex items-center gap-0.5">
                    {(() => {
                      ...
                      return uniqueIcons.map(({ dep, icon: Icon }) => (
                        <div
                          key={dep}
                          className="text-muted-foreground hover:border-border hover:text-foreground flex size-5 items-center justify-center border border-transparent transition-all"
                          title={dep}
                        >
