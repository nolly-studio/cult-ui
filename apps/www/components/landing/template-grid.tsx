    ...
    <section className="mx-auto max-w-6xl py-16 md:px-4 md:py-24">
      ...
      <div className="mb-12 text-center">
        ...
        <div className="mx-auto mb-8 flex max-w-xl items-center justify-center gap-4">
          ...
          <div className="border-border/60 bg-background flex items-center gap-2 rounded-md border px-3 py-1.5">
      ...
      {/* Templates Grid */}
      <div className="bg-muted shadow-elevation-light m-2 grid gap-4 rounded-lg p-2 sm:m-0 sm:grid-cols-2 lg:grid-cols-3">
