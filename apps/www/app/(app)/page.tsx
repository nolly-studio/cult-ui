		...
		<div className=" isolate min-h-screen overflow-hidden  pb-8 sm:pb-12 md:pb-0">
			<div className="container relative py-12 md:pt-0">
				<PageHeader>
					...
					{/* Hero Title */}
					<div className="py-2">
						<h1 className="text-center text-3xl font-semibold leading-tight tracking-tighter md:text-4xl lg:text-7xl lg:leading-[1.1]">
							Shadcn, expanded
						</h1>
					</div>
					...
					<PageActions>
						...
						>
							Browse {componentCount} Free Components
						</Link>
						<Link
							target="_blank"
							rel="noreferrer"
