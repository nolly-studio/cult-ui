      ...
      <BgNoiseWrapper url="/egg-shell-noise.png">
        <div className="container relative pt-12">
          ...
          <section className="   w-full md:block">
            <FadeIn>
              <div className=" mx-auto max-w-7xl rounded-[44px] border border-black/5 p-2 shadow-sm ">
                <PlugCardGrid />
              </div>
            </FadeIn>
          </section>
          ...
          <div className=" mx-auto mt-12 w-full  max-w-7xl ">
            <FadeIn>
              <div className="relative flex w-full flex-col rounded-[44px] border border-black/5 p-2 shadow-sm md:flex-row md:items-center md:gap-24 md:p-6">
                ...
                >
                  <SparklesIcon className="fill-[#AFB9E2] stroke-1 text-neutral-800" />{" "}
                  Latest component
                </Badge>
                <div className="flex flex-col justify-center pb-2 pl-2 pt-16 md:items-center">
                  <div className="flex  gap-2">
                    ...
                    <div>
                      <GradientHeading>Agent Workflow</GradientHeading>
                      <Link
                        href="/docs/components/sortable-list"
                        className="flex items-center gap-1 "
                      >
                        Built with SortableList{" "}
